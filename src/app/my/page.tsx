  ...
  const copy =
    locale === "zh"
      ? {
          ...
          title: "我的工作台",
          desc: `${displayName}，这里是 core 前端的个人入口总览。你可以在运行记录、Agent 发布、Agent 管理和账户设置之间切换。`,
          hub: "Agent 管理",
          creatorKicker: "Agent 管理",
          publish: "发布 Agent",
          creatorTitle: "Agent 管理 / 我的 Agent",
          creatorDesc: "查看已发布 Agent、接入凭证、Skill 声明、跨节点 Bridge、调用记录和投递/回调设置。这里是管理“我拥有的 Agent”的主入口。",
          agentCount: "个 Agent",
      ...
      : {
          ...
          title: "My Workspace",
          desc: `Hi ${displayName}, this is your core frontend overview. Switch between runs, Agent publishing, Agent Console, and account settings.`,
          hub: "Agent Console",
          creatorKicker: "Agent Console",
          publish: "Publish Agent",
          creatorTitle: "Agent Console / My Agents",
          creatorDesc: "Review published Agents, access credentials, Skill declarations, cross-node Bridge, run history, and delivery/callback settings. This is the home for Agents you own.",
          agentCount: "Agents",
