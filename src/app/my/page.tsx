  ...
  const copy =
    locale === "zh"
      ? {
          ...
          newAgent: "发布新 Agent",
          newAgentDesc: "手动发布 HTTP Endpoint、Agent Node WebSocket 或 Pull 降级 Agent；无人值守场景可生成注册邀请。",
          connect: "开发者中心",
      ...
      : {
          ...
          newAgentDesc: "Manually publish HTTP endpoints, Agent Node WebSocket, or Pull fallback Agents; unattended flows can use a registration invite.",
