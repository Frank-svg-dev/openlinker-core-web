  ...
  const copy =
    locale === "zh"
      ? {
          ...
          tokenCreated: "Agent Token 已创建",
          tokenCreateFailed: "创建 Agent Token 失败",
          ...
          creating: "创建中",
          create: "创建",
          tokenHint: "Agent Token 明文仅显示一次，请配置到 Agent Node。它只绑定当前 Agent。",
          copied: "已复制",
          copyToken: "复制 Token",
          revoke: "撤销",
          empty: "尚未创建 Agent Token。它只绑定当前 Agent，不能更改账号设置、创建 User Token 或管理其他 Agent。",
        }
      : {
          ...
          tokenCreateFailed: "Failed to create Agent Token",
          ...
          creating: "Creating",
          create: "Create",
          tokenHint: "The Agent Token plaintext is shown only once. Configure it in Agent Node. It is bound to this Agent only.",
          copied: "Copied",
          copyToken: "Copy token",
          revoke: "Revoke",
          empty: "No Agent Token yet. It is bound to this Agent and cannot change account settings, create User Tokens, or manage other Agents.",
        };
