  ...
  const copy =
    locale === "zh"
      ? {
          ...
          unavailableBody: "当前页面仍会展示已存在的测评结果，但不会让你发起一个必然失败的新测评。",
          reason: "原因",
      ...
      : {
          ...
          unavailableBody: "Existing benchmark results are still shown, but the page will not start a new benchmark that is known to fail.",
          reason: "Reason",
