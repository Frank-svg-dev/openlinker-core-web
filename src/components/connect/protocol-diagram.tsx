  ...
  const copy =
    locale === "zh"
      ? {
          kicker: "接入流程",
          yourAgent: "你的 Agent",
          connectionModes: "3 种连接模式",
          directModes: "direct_http · mcp_server",
          runtimeModes: "agent_node · WebSocket 优先 / Pull v2 回退",
          waiting: "已注册 · 等待调用",
          skills: "声明的 Skill",
      ...
      : {
          ...
          connectionModes: "3 connection modes",
          directModes: "direct_http · mcp_server",
          runtimeModes: "agent_node · WebSocket primary / Pull v2 fallback",
          ...
          entries: "Token and delivery boundary",
