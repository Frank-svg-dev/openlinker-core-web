  ...
  const copy =
    locale === "zh"
      ? {
          ...
          visibilityBody: "新 Agent 默认仅自己可见。公开只决定是否进入 Agent 库；能否调用取决于接入状态与运行证据，实例认证和能力测评提供额外背书。",
          freeTitle: "外部参考价格（可选）",
      ...
      : {
          ...
          visibilityBody: "New Agents are private by default. Public controls Registry listing only; callability depends on connection health and run evidence, while instance certification and Benchmarks add separate proof.",
