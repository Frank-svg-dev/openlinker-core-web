  ...
  zh: [
    {
      ...
      signal: "健康检查",
      evidence: "/healthz",
      detail: "Agent 调用、Registry 查询和用户运行入口。",
      path: "/healthz",
    },
    {
      id: "database",
      ...
      signal: "DB 健康检查",
      evidence: "/healthz/db",
      detail: "用户、Agent、Skill 和运行记录的主存储。",
      path: "/healthz/db",
    },
    {
      id: "registry",
      ...
      detail: "Agent Registry 查询、Agent 详情和 Skill 过滤。",
  ...
  en: [
    {
      ...
      signal: "Health check",
      evidence: "/healthz",
      detail: "Entry point for Agent calls, Registry queries, and user runs.",
      path: "/healthz",
    },
    {
      id: "database",
      ...
      evidence: "/healthz/db",
      detail: "Primary store for users, Agents, Skills, and run records.",
      path: "/healthz/db",
    },
    {
      id: "registry",
      ...
      signal: "Public API",
      evidence: "/api/v1/agents",
      detail: "Agent Registry queries, Agent detail, and Skill filtering.",
      path: "/api/v1/agents?size=1",
    },
    {
      id: "discovery",
