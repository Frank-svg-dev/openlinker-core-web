...
export const agentOnboardingMessages = {
  ...
  en: {
    ...
    tokenPolling: "Open a Runtime v2 session with the Node device certificate and the Agent Token bound to this Agent. If WebSocket is blocked, switch to the same v2 long-poll protocol without exposing the private network.",
...
export const automationAccessMessages = {
  zh: {
    created: "Agent Token 已生成，明文仅本次显示",
    createFailed: "生成失败",
    ...
    copiedToken: "已复制 Agent Token",
    copyFailed: "复制失败，请手动选中",
    title: "签发 Agent Token",
    bodyPrefix: "只有当本地脚本、CLI 或外部 Agent 需要在无人值守环境自行注册时，才需要这类凭证。手动接入仍走",
    publish: "接入新 Agent",
    bodySuffix: "Agent Token 有效期为 30 分钟，请在到期前完成首次注册；注册成功后，同一个 Token 会绑定到该 Agent。",
    creating: "生成中...",
    create: "签发 Agent Token",
    secretOnce: "Agent Token 明文仅显示一次。建议直接复制启动包给 Agent；完整接入步骤请看 /skill/publish-agent。",
  ...
  en: {
    ...
    copiedToken: "Agent Token copied",
    ...
    bodySuffix: "The Agent Token expires in 30 minutes. Complete the first registration before it expires; after registration, the same Token is bound to that Agent.",
    creating: "Creating...",
    create: "Issue Agent Token",
    ...
    copiedTokenButton: "Agent Token copied",
    copyTokenButton: "Copy Agent Token only",
    ...
    generated: (count: number) => `${count} Agent Token records generated. Agent Tokens are only for Agent registration and runtime; they cannot replace User Tokens for API or MCP calls.`,
    sortBy: "Sort",
    sortDir: "Direction",
    sortCreated: "Created",
