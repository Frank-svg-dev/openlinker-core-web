...
export const coreUserTokenMessages = {
  zh: {
    ...
    presetCopy: {
      ...
      "agent-token": { label: "Agent Token 管理", description: "查看、签发和撤销自有 Agent Token。" },
    },
  },
  en: {
    ...
    replaceDescription: "Start from the current token's access and issue a replacement User Token. Deploy it before revoking the old token.",
    name: "Name",
    ...
    prefixCopied: "Token identifier copied. It is not the plaintext User Token.",
    ...
    permissionCopy: {
      ...
      "tasks:read": { label: "Read Tasks", description: "Read your private Tasks." },
      ...
      "agent-tokens:issue": { label: "Issue Agent Tokens", description: "Issue or rotate Agent Tokens for owned Agents, optionally limited by Agent." },
      "agent-tokens:revoke": { label: "Revoke Agent Tokens", description: "Revoke Agent Tokens for owned Agents, optionally limited by Agent." },
    },
    presetCopy: {
      ...
      "agent-token": { label: "Agent Token management", description: "Read, issue, and revoke Agent Tokens for owned Agents." },
    },
  },
